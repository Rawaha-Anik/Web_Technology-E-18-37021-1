				...
				<fieldset style="width: 70%">
						...
						<table>
							...
							<tr>
								...
								<td> : &nbsp <input type="password" id="Current_Password" name="Current_Password" size="35%"> 
                                <span class="SecondaryFont"><?php echo $passwordErr;?></span>
								<br/></td>
							</tr>
                            <tr>
								<td>New Password </td>
								<td> : &nbsp <input type="password" id="New_Password" name="New_Password" size="35%"> 
								<br/></td>
							</tr>
                            <tr>
								<td>Confirm Password </td>
								<td> : &nbsp <input type="password" id="Confirm_Password" name="Confirm_Password" size="35%"> 
								<br/> </td>
							</tr>
							<tr> <td colspan="2"> <hr> </td> </tr>
					    </table>
