                ...
                <td colspan="2">
                	...
                	<tbody>
			            ...
			            <tr>
				            ...
				            <td><a href="removeUser.php?Username=<?php echo $user['Username'] ?>" onclick="return confirm('Are you sure want to delete this ?')">Delete</a></td>
			            </tr>
		                <?php endforeach; ?>
                	</tbody>
                    </table>
